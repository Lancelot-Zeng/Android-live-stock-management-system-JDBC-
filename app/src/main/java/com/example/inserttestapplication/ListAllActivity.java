...
import java.util.List;
    ...
    public class ListAllActivity extends AppCompatActivity {
        ...
        private class SyncData extends AsyncTask<String, String, String> {
            ...
            {
                progress = ProgressDialog.show(ListAllActivity.this, "Synchronising",
            ...
            protected String doInBackground(String... strings)  // Connect to the database, write query and add items to array list
            {
                try {
                    ...
                    if (conn == null) {
                        ...
                        String query = "SELECT Brick_type,batch,row , quantity FROM brick order by row asc";
            ...
            {
                progress.dismiss();
                Toast.makeText(ListAllActivity.this, msg + "", Toast.LENGTH_LONG).show();
                if (success == false) {
                } else {
                    try {
                        myAppAdapter = new MyAppAdapter(itemArrayList, ListAllActivity.this);
